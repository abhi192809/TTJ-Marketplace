...
<div class="container-fluid ">
    <div class="row p-2">
        <div class="mb-3 col-md-12">
            ...
            <spam style="color:red"><a class="text-danger" href="<?php echo  base_url() ?>/Meeting/Admin/buyer/buyer_data_view"><span class="share-btnnn"><i class="fa fa-share rotate-190" id="backButton"></i> Back</span></a> Buyer</spam>  Register Now <?= $Event->EventPlace ?> <?= date('jS F Y', strtotime($Event->EventStartDate)) ?>
        </h3>
        </div>
