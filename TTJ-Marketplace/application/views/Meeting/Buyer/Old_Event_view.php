...
<div class="container-fluid">
    <!-------------------div-------------->
       ...
       <!-- <h4 class="form-data-heading mb-0">All Event View</h4>-->
       <!-- </div>-->
       <!-- </div>-->
  ...
  <!-------------end----------------->
    <div class="margtoppp-data-form card">
     <div class="card-header1">
     <h4 class="form-data-heading mb-0" style="padding-left: 15px">All Event View</h4>
     </div>
      <div class="table-responsive card-body">
        ...
        foreach($view_Event as $row ){
              $this->load->model('Meeting_model/Event_model');
                ...
                $data = $this->Event_model->Event_ID_Buyer_ID($row->EventID, $BuyerID); 
