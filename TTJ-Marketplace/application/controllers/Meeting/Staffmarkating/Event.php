...
class Event extends CI_Controller
{
 ...
 public function __construct()
    ...
    public function EventCreat(){
        ...
        $this->load->view('Meeting/Staff-markating/Event_Creat_view',$data);
    ...
    public function ActiveEvent(){
        ...
        $this->load->view('Meeting/Staff-markating/sidebar');
        $this->load->view('Meeting/Staff-markating/topbar');
        $this->load->view('Meeting/Staff-markating/Active_Event_view');
        $this->load->view('Meeting/Staff-markating/footer');   
    }
    ...
    public function OldEvent(){
        ...
        $this->load->view('Meeting/Staff-markating/sidebar');
        $this->load->view('Meeting/Staff-markating/topbar');
        $this->load->view('Meeting/Staff-markating/Old_Event_view',$data);
        $this->load->view('Meeting/Staff-markating/footer');   
    }
